...
def binn_mlp_mnist(inp, weights, biases, use_bias=True, training=True):
    ...
    l0 = bin_dense_layer(inp, weights['w0'], biases['b0'], 2048, use_bias=use_bias, bin_inp=False, training=training, name='bin_dense_l0')
    ...
    l1 = bin_dense_layer(l0_htanh, weights['w1'], biases['b1'], 2048, use_bias = use_bias, bin_inp=True, training=training, name='bin_dense_l1')
    ...
    l2 = bin_dense_layer(l1_htanh, weights['w2'], biases['b2'], 2048, use_bias=use_bias, bin_inp=True, training=training, name='bin_dense_l2')
    ...
    l3 = bin_dense_layer(l2_htanh, weights['w3'], biases['b3'], 10, use_bias=use_bias, bin_inp=True, training=training, name='bin_dense_l3')
